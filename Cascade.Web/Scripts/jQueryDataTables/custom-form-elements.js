    ...
    CustomFormElements.prototype = {
        init: function(options) {
            ...
            var css = [
                ...
                'select.', self.options.styled, '{position:relative;width:', self.options.selectWidth, 'px;opacity:0;filter:alpha(opacity=0);z-index:9999;}', //jcox, updated z-index from 5 to 9999
