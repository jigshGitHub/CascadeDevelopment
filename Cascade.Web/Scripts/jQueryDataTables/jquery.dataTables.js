        ...
        "full_numbers": {
            ...
            */
            ...
            "fnUpdate": function (oSettings, fnCallbackDraw) {
                ...
                var sList = "";
                var oClasses = oSettings.oClasses;
                var iPageBegin1, iPageEnd1, iPageBegin2, iPageEnd2, bMiddlePaging, i;
                ...
                if (iPages < 8) {
                    ...
                    iPageBegin1 = 1;
                    iPageEnd1 = 4;
                    iPageBegin2 = iPages - 3;
                    iPageEnd2 = iPages;
                }
                if (!((iCurrentPage >= iPageBegin1 && iCurrentPage < iPageEnd1) || (iCurrentPage > iPageBegin2 && iCurrentPage <= iPageEnd2))) {
                    if (iPageBegin2 != null) {
                        iPageEnd1 -= 2;
                        iPageBegin2 += 2;
                        bMiddlePaging = true;
                ...
                /* Build the 1st dynamic list */
                for (i = iPageBegin1; i <= iPageEnd1; i++) {
                    if (iCurrentPage != i) {
                ...
                /* Build the middle elipses dynamic list */
                if (iPageBegin2 !== null && !bMiddlePaging) {
                    sList += '...';
                }
                else if (iPageBegin2 !== null && bMiddlePaging) {
                    sList += '...';
                    sList += '<span class="' + oClasses.sPageButton + '">' + (iCurrentPage - 1) + '</span>';
                    //if (iCurrentPage < iPageEnd2 && iCurrentPage < iPageEnd1)
                    sList += '<span class="' + oClasses.sPageButtonActive + '">' + iCurrentPage + '</span>';
                    //if (iCurrentPage + 1 < iPageEnd2 && iCurrentPage + 1 < iPageEnd1)
                    sList += '<span class="' + oClasses.sPageButton + '">' + (iCurrentPage + 1) + '</span>';
                    sList += '...';
                }
                /* Build the 2nd dynamic list */
                if (iPageBegin2 !== null) {
                    for (i = iPageBegin2; i <= iPageEnd2; i++) {
                        if (iCurrentPage != i) {
                            sList += '<span class="' + oClasses.sPageButton + '">' + i + '</span>';
                        }
                        else {
            ...
            * Inputs:   object:oSettings - dataTables settings object
            *           function:fnCallbackDraw - draw function to call on page change
            * NOTE: THIS WAS THE ORIGINAL PAGINATION FORMAT FOR DATATABLES.  MODIFIED ABOVE PER CLIENT REQUEST.
            */
            "fnUpdate2": function (oSettings, fnCallbackDraw) {
                if (!oSettings.aanFeatures.p) {
                    return;
                }
    ...
    $.fn.dataTable = function (oInit) {
        ...
        */
        function _fnFeatureHtmlFilter(oSettings) {
            ...
            nFilter.innerHTML = oSettings.oLanguage.sSearch + sSpace + '<div class="data_tables_search"><input type="text" /><input type="submit" class="widget_submit_search"/></div><div class="sort_instructions">Click on headers to sort by column</div>';
