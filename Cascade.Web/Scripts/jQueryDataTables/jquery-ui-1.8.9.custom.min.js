 ...
 *	jquery.ui.resizable.js
    ...
    Comment: Pivotal Tracker id: 28463153 : This .js file is used when user closes model pop-up page - Dashboard - Contact View - Contact Edit. The parent page has 
    Performance Chart Start Date and End Date - Dropdownlist boxes. We need to make them Active(Enabled) once user closes the Model popup page
    and returns back to parent page.
 */
...
"button").hover(function(){h.addClass("ui-state-hover")},function(){h.removeClass("ui-state-hover")}).focus(function(){h.addClass("ui-state-focus")}).blur(function(){h.removeClass("ui-state-focus")}).click(function(i){$('#performance_chart_end_date').removeAttr("disabled");$('#performance_chart_start_date').removeAttr("disabled");a.close(i);return false}).appendTo(f);(a.uiDialogTitlebarCloseText=c("<span></span>")).addClass("ui-icon ui-icon-closethick").text(b.closeText).appendTo(h);c("<span></span>").addClass("ui-dialog-title").attr("id",e).html(d).prependTo(f);if(c.isFunction(b.beforeclose)&&!c.isFunction(b.beforeClose))b.beforeClose=
